...
// Conntendo
void Nes_Apu::mutechannels( bool* muteSetting)
{
	muteChannel[0] = muteSetting[0];
	muteChannel[1] = muteSetting[1];
	muteChannel[2] = muteSetting[2];
	muteChannel[3] = muteSetting[3];
	muteChannel[4] = muteSetting[4];
}
